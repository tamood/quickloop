...
class ChipyardFIRRTLDSE1Env(gym.Env):
    ...
    def build_chipyard(self, action):
        ...
        buid_env['BooleanConfig'] = f'{sum([a << i for i, a in enumerate(action)])}'
    ...
    def __init__(self, config):
        ...
        super(ChipyardFIRRTLDSE1Env, self).__init__()
        # Define action and observation space
        self.action_space = MultiBinary(20)
