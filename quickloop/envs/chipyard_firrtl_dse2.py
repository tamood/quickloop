...
class ChipyardFIRRTLDSE2Env(gym.Env):
    ...
    def build_chipyard(self, action):
        ...
        for param, a in zip(['meshRC', 'accFactor', 'spadFactor', 'tilelat'], action):
            buid_env[param] = f'{a}'
    ...
    def __init__(self, config):
        ...
        super(ChipyardFIRRTLDSE2Env, self).__init__()
        # Define action and observation space
        self.action_space = MultiDiscrete(np.array([3, 6, 6, 3]))
