...
class ChipyardFIRRTLDSEEnv(gym.Env):
    ...
    def __init__(self, config):
        ...
        super(ChipyardFIRRTLDSEEnv, self).__init__()
        # Define action and observation space
        self.action_space = MultiDiscrete(np.array([1 << 19, 3, 6, 6]))
