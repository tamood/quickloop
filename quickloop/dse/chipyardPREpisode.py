from fast.envs import ChipyardFIRRTLDSEEnv, FIRRTLVerilogEmitter, ChipyardVivadoPRFlowEnv, ChipyardAnalyzeEnv
...
envflow = ChipyardVivadoPRFlowEnv(c)
envf.reset()
envflow.reset()
...
f = open('/work/tayyeb/results/prepisode.json', 'w')
