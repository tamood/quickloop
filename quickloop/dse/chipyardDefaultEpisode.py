from fast.envs import ChipyardFIRRTLDSEEnv, FIRRTLVerilogEmitter, ChipyardVivadoDefaultFlowEnv, ChipyardAnalyzeEnv
...
f = open('/work/tayyeb/results/defaultepisode2.json', 'w')
